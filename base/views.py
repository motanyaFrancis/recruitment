    ...
    async def get(self, request):
        try:
            ...
            async with aiohttp.ClientSession() as session:
                ...
                get_ethnicCommunities = asyncio.ensure_future(self.simple_fetch_data(session,
                                                                                     '/QyEthnicCommunities'))
                ...
                ethnicCommunities = [community for community in response[8]]
